\chapter[Preguntas de Entrevista DBA]{\emj{🎤}~Preguntas de Entrevista DBA}

Este capítulo consolida las preguntas de todos los capítulos más preguntas adicionales, organizadas por tema.
Las respuestas completas están en los capítulos correspondientes; este capítulo sirve para repasar y autoevaluarse.

\section[\emj{🎤} SQL]{\emj{🎤}~SQL}
...
\section[\emj{🎤} Índices y rendimiento]{\emj{🎤}~Índices y rendimiento}
...
\section[\emj{🎤} Transacciones y concurrencia]{\emj{🎤}~Transacciones y concurrencia}
...
\section[\emj{🎤} Modelado y diseño]{\emj{🎤}~Modelado y diseño}
...
\section[\emj{🎤} NoSQL y arquitectura distribuida]{\emj{🎤}~NoSQL y arquitectura distribuida}
...
\section[\emj{🎤} Administración y operaciones]{\emj{🎤}~Administración y operaciones}
